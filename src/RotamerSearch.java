...
//// BEGIN ROTAMER SEARCH SECTION
    ...
    private void slaveRotamerSearchAStar(int numMutable, int strandMut[][], boolean minimizeBB,
        ...
        while (numConfsLeft.compareTo(BigInteger.ZERO)==1) {
            ...
            for(int i=0; i<treeLevels; i++)System.out.print(conf[i]+" ");
            System.out.println();
...
//////////////////////////////////////////////////////////////////////////
    ...
    private float doAStarGMECHelper(int numMutable, int strandMut[][], String fileName,
        ...
        for(int i=0; i<treeLevels; i++)System.out.print(numRotForRes[i]+" ");
        System.out.println();
        ...
        for(int i=0; i<treeLevels; i++)System.out.print(numRotForResNonPruned[i]+" ");
        System.out.println();
        ...
        for (int i=0; i<AAdefault.length; i++)System.out.print(AAdefault[i]+" ");
        System.out.println();
        ...
        while (true) {
            ...
            for(int i=0; i<treeLevels; i++)System.out.print(curConf[i]+" ");
            System.out.println();
            ...
            for(int i=0; i<numMutable; i++)System.out.print(ASAANums[i]+" ");
            System.out.println("");
